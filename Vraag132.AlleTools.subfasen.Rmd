...
d <- c("##Discovery
The triplets of VU and VUmc favourites---Acrobat Reader, Google Scholar, institutional access--- are favoured in the OECD as well. For searching, PubMed and Mendeley are used more often by VU staff, while Scopus is used less (no surprise here, since the VU has no subscription at the time of the survey). ",
"##Analysis
