...
{ 
  ...
  barplot(ToolUse.Phase.i[1:3], main=paste("3 most popular tools for Research ",PhaseResearchCycle[i]," at the VU&VUmc"),xlim=c(0,max(ToolUse.totaal)),
          xlab="N tool users (filled color = supported by VU Library)",
