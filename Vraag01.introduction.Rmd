...
As a reader you can also can make public and private annotations on this URL of this report. (See top-right corner) You can start highlighing the content in this document and save your thoughts right from the browser as you read for later, or share with others. We do so encourage you to do so. (In case you save the html file, be aware that web annotations are based on the web address, if the address changes, the annotations will not move with it.)
...
In total we had 839 visits to this short URL. As you can see in the results section, 531 people finaly filled in the survey, from a population of 3772 people scientific staff at VU and VUmc. Whis is respectively 22% and 14%.
...
![*Data Scaffold: survey dataset enriched with additional data for making plots.*](./images/vu101-data-scaffold.png "Data Scaffold, enriching data for creating plots.")
...
![*Code Scaffold: From data to Report; making separate plots from data, put plots in each question, include commentary, and placing each question in the report.*](./images/vu101-code-scaffold.png "Code Scaffold; nesting files creating plots, incuding commentary")
