...
# Career groups and Tool usage <!-- (1.1.1) --> {#sec:tenure}
...
## Tenured vs non-tenured researchers {#ssec:tenure:top2}
<!-- ## Extremities: Tenures vs Non-tenures -->
```{r child="Vraag111.top2.fasen.Rmd", echo=FALSE, fig.width=12, out.width=910}
```

## Tenured vs non-tenured researchers: detail {#ssec:tenure:detail}
