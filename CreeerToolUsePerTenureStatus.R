...
ToolUse.per.TenureStatus[1,]<- (colSums(VU101.Nontenured)/dim(VU101.Nontenured)[1])*100
Participants.TenureStatus[1]<- dim(VU101.Nontenured)[1]
...
ToolUse.per.TenureStatus[2,]<- (colSums(VU101.Tenured)/dim(VU101.Tenured)[1])*100
Participants.TenureStatus[2]<- dim(VU101.Tenured)[1]
