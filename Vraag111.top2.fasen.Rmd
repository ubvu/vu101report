The figures below shows for each research phase the tools with the biggest difference between tenured and non-tenured researchers. Usage in the tenured group is represented in solid colored bars; non-tenured use in shaded bars. The Figures in further [sections](#ssec:tenure:detail) show the data in more detail. We discuss the main elements of both the largest differences and the more detailed figures below.
